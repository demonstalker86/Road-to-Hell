...
public class RoadController : MonoBehaviour
{
        ...
        void Instations()
    {
        ...
        prefab1.transform.localScale = new Vector3(0.4f, 0.7f, 0.3f);
        prefab1.name = "NPC_car1";
        GameObject prefab2 = Instantiate(Object2,Pos2.position,Quaternion.Euler(0, 0, -90), gameObject.transform);
        prefab2.transform.localScale = new Vector3(0.4f, 0.7f, 0.3f);
        prefab2.name = "NPC_car2";
